/*
    ...
    Date: Febuary 13, 2026 10:47 PM
    Purpose: Project 2: Blackjack
    Version 4
    Version Notes: changed drawC into a 2D array and added session stats
...
int main(int argv,char **argc){
    ...
    const int maxGame = 100; // Global constant or inside main
    char results[maxGame];   // 1D array to store 'W', 'L', or 'P'

/*
    ...
    Date: Febuary 13, 2026 2:04 PM
    Purpose: Project 2: Blackjack
    Version 1
    Version Notes: added functions to show rules,play with bets, and play without bets
...
void ybetgam(string pName, float &bal, int &winP, int &lossP, int &gameNum){//games with bets
    ...
    gameNum++;//increase game counter
        ...
        //player cards
        cardP = rand() % 10 + 2;//player card 1
        totalP += cardP;
        cout<<endl<<pName<<" Card 1: "<<cardP<<endl;
        cardP = rand() % 10 + 2;//player card 2
        totalP += cardP;
        cout<<pName<<" Card 2: "<<cardP<<endl<<endl;

        //dealer cards
        cardD = rand() % 10 + 2;//dealer card 1
        totalD += cardD;
        cout<<"Dealer Card 1: "<<cardD<<endl;
        cardD = rand() % 10 + 2;//dealer card 2
        totalD += cardD;
        cout<<"Dealer Card 2: "<<cardD<<endl<<endl;
        ...
        while(totalP < 21 && !pStand){//if no instant blackjacks
            if(stopgam==false){
                ...
                if(stdOrhi=='h' || stdOrhi=='H'){//if player hits
                    cardP = rand() % 10 + 2;//player card 3+
                    totalP += cardP;
                    pCarNum++;
                    cout<<endl<<pName<<"'s Card "<<pCarNum<<": "<<cardP<<endl;
                    cout<<pName<<" has: "<<totalP<<endl;//show player total
        ...
        while(totalD < 17){//dealer stands on 17
            if(stopgam == false){
                cardD = rand() % 10 + 2;//dealer card 3+
                totalD += cardD;
                dCarNum++;
                cout<<endl<<"Dealer Card "<<dCarNum<<": "<<cardD<<endl;

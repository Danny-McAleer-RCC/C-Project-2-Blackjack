/*
    ...
    Date: Febuary 14, 2026 12:01 PM
    Purpose: Project 2: Blackjack
    Version 9
    Version Notes: added overloaded functions and another type cast and fixed problems from v8
...
void playgam(string pName, float &bal, int &winP, int &lossP, int &gameNum, int &totlDra, char results[]);//betting enabled
void playgam(string pName, int &winP, int &lossP, int &gameNum, int &totlDra, char results[]);//betting disabled
...
int main(int argv,char **argc){
    ...
    while(play=='Y' || play == 'y'){
        ...
        if(betting == true){
            playgam(pName, bal, winP, lossP, gameNum, totlDra, results);//with betting
        }else if(betting == false){
            playgam(pName, winP, lossP, gameNum, totlDra, results);//without betting
        }
...
void playgam(string pName, float &bal, int &winP, int &lossP, int &gameNum, int &totlDra, char results[]){//games with bets
    //Declare Varibles
        /*
        C++ Varible Guidelines:
        7 characters or less
...
void playgam(string pName, int &winP, int &lossP, int &gameNum, int &totlDra, char results[]){//games without bets
    //Declare Varibles
        /*
        C++ Varible Guidelines:
        7 characters or less

/*
    ...
    Date: Febuary 14, 2026 12:37 PM
    Purpose: Project 2: Blackjack
    Version 10
    Version Notes: added sizeof and fixed decks
...
int main(int argv,char **argc){
    ...
    while(play=='Y' || play == 'y'){
        ...
        if(betting == true){
            playgam(pName, bal, winP, lossP, gameNum, totlDra, results, deck);//with betting
        }else if(betting == false){
            playgam(pName, winP, lossP, gameNum, totlDra, results, deck);//without betting
        }
    ...
    netChan = static_cast<float>(bal - 1000.00);//set net change
    ...
    cout<<"Storage size of results: "<<sizeof(results)<<" bytes"<<endl;
